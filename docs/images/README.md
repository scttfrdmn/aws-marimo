...
running `notebook_weather.py` via the bridge.

| File | Priority | What to capture |
|---|---|---|
| `marimo-on-sagemaker.png` | **essential** | Hero shot: `notebook_weather.py` running live — station dropdown + σ-slider on top, chart below (blue actual / orange fit / red anomalies), address bar showing `/jupyterlab/default/proxy/2719/`. |
